...
const { getWaitingTaskAndSelect, finishTask, getTasks } = require("./tasks.repo")
...
const getTasksStatus = async () => {
  ...
  for (let t of tasks) {
    ...
    t.timeSinceLaunch = Math.floor(time / 1000 / 3600) + ":" + 
...
module.exports = {runTasksUntilEmpty, getTasksStatus}
